...
const headerMenu=document.querySelector(".header__menu"),headerBlank=document.querySelector(".header__blank"),pawIcon=document.querySelectorAll(".paw-icon"),modal=document.querySelector(".modal"),modalClose=document.querySelector(".modal__close"),modalForm=document.querySelector(".contacts__form");for(btn of(headerMenu.addEventListener("click",(()=>headerBlank.classList.toggle("header__blank_vis"))),pawIcon))btn.addEventListener("click",(()=>modal.classList.add("modal_vis")));modalClose.addEventListener("click",(()=>modal.classList.remove("modal_vis")));
