...
"use strict";var headerMenu=document.querySelector(".header__menu"),headerBlank=document.querySelector(".header__blank"),pawIcon=document.querySelectorAll(".paw-button__icon"),modal=document.querySelector(".modal"),modalClose=document.querySelector(".modal__close"),modalForm=document.querySelector(".contacts__form");headerMenu.addEventListener("click",(function(){return headerBlank.classList.toggle("header__blank_vis")})),pawIcon.forEach((function(e){e.addEventListener("click",(function(){return modal.classList.add("modal_vis")}))})),modalClose.addEventListener("click",(function(){return modal.classList.remove("modal_vis")}));var swiper=new Swiper(".help__swiper",{direction:"horizontal",loop:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),petSwiper=new Swiper(".pet__swiper",{navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});function init(){var e=new ymaps.Map("map",{center:[55.848271,37.37536],zoom:14}),t=new ymaps.Placemark([55.848271,37.37536],{},{iconLayout:"default#image",iconImageHref:"img/mark.svg",iconImageSize:[39,59]});e.geoObjects.add(t),t.events.add("hover",(function(e){e.get("target").options.set("iconImageSize",[49,75])}))}ymaps.ready(init);
